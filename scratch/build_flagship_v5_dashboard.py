...
html_v5_code = f"""<!DOCTYPE html>
<html lang="th" data-theme="dark">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>NKP Medical Oxygen Analytics Dashboard V5</title>
...
<body>
    ...
    <aside class="sidebar" id="appSidebar">
        ...
        <!-- Vertical Sidebar Menu Bar with Distinct Symbols & Tooltips -->
    ...
    <script>
        ...
        function renderKPIs() {{
            ...
            if (activeTab === 'daily' || activeTab === 'cost') {{
                ...
                grid.innerHTML = `
                    <div class="kpi-card" style="border-left: 4px solid var(--accent-emerald);">
                        <i class="fa-solid fa-hospital kpi-icon" style="color: var(--accent-emerald);"></i>
                        <div class="kpi-label">คลังท่อสำรอง รพ.นครพิงค์ (พื้นที่หลัก)</div>
                        <div class="kpi-value">144 <span style="font-size: 1rem; color: var(--text-muted);">ท่อ</span></div>
                        <div class="kpi-subtext">รวม 908 m³ (สำรองจ่ายได้นาน 9.09 ชั่วโมง)</div>
                    </div>
                    <div class="kpi-card" style="border-left: 4px solid var(--accent-purple);">
                        <i class="fa-solid fa-notes-medical kpi-icon" style="color: var(--accent-purple);"></i>
                        <div class="kpi-label">คลังท่อสำรอง ศูนย์มะเร็งขอนตาล</div>
                        <div class="kpi-value">18 <span style="font-size: 1rem; color: var(--text-muted);">ท่อ</span></div>
                        <div class="kpi-subtext">รวม 114 m³ (สำรองจ่ายได้นาน 55 ชั่วโมง / 2.29 วัน)</div>
                    </div>
                    <div class="kpi-card" style="border-left: 4px solid var(--primary-cyan);">
                        <i class="fa-solid fa-boxes-stacked kpi-icon" style="color: var(--primary-cyan);"></i>
                        <div class="kpi-label">รวมท่อสำรองทั้งองค์กร</div>
                        <div class="kpi-value">162 <span style="font-size: 1rem; color: var(--text-muted);">ท่อ</span></div>
                        <div class="kpi-subtext">รวม 1,022 m³ (จ่ายสำรองรวมได้นาน 9.44 ชั่วโมง)</div>
                    </div>
                    <div class="kpi-card" style="border-left: 4px solid var(--accent-rose);">
                        <i class="fa-solid fa-truck-medical kpi-icon" style="color: var(--accent-rose);"></i>
                        <div class="kpi-label">การันตีจัดส่งฉุกเฉิน (SLA)</div>
                        <div class="kpi-value" style="color: var(--accent-emerald);">3.00 ชม.</div>
        ...
        function renderEmergencyModule() {{
            ...
            content.innerHTML = `
                ...
                <div class="content-card">
                    <div class="section-title">
                        <i class="fa-solid fa-boxes-stacked" style="color: var(--primary-cyan);"></i> ตารางรายละเอียดคลังท่อสำรองประจำสเตชั่น 8 อาคาร
                    </div>
                    <div class="table-wrapper">
                        <table>
                            <thead>
                                <tr>
                                    <th>ลำดับ</th>
                                    <th>สถานที่ / สเตชั่นจ่ายประจำอาคาร</th>
                                    <th>จำนวนท่อ (6 m³)</th>
                                    <th>จำนวนท่อ (7 m³)</th>
                                    <th>รวมจำนวนท่อ</th>
                                    <th>ปริมาตรแก๊สสำรอง</th>
                                    <th>ระยะเวลาจ่ายสำรองฉุกเฉิน</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr><td>1</td><td><strong>โรงพยาบาลนครพิงค์ (ตึก 1 - 7 รวม 7 สเตชั่น)</strong></td><td>100 ท่อ</td><td>44 ท่อ</td><td><strong>144 ท่อ</strong></td><td>908 m³</td><td><strong style="color: var(--accent-emerald);">9.09 ชั่วโมง</strong></td></tr>
                                <tr><td>2</td><td><strong>ศูนย์มะเร็งขอนตาล (สเตชั่น 8)</strong></td><td>12 ท่อ</td><td>6 ท่อ</td><td><strong>18 ท่อ</strong></td><td>114 m³</td><td><strong style="color: var(--accent-emerald);">55.08 ชั่วโมง (2.29 วัน)</strong></td></tr>
                                <tr style="background: rgba(6, 182, 212, 0.1);"><td>-</td><td><strong>ยอดรวมคลังท่อสำรองทั้งองค์กร</strong></td><td><strong>112 ท่อ</strong></td><td><strong>50 ท่อ</strong></td><td><strong style="color: var(--primary-cyan);">162 ท่อ</strong></td><td><strong>1,022 m³</strong></td><td><strong style="color: var(--primary-cyan);">9.44 ชั่วโมง</strong></td></tr>
                            </tbody>
                        </table>
                    </div>
                </div>
...
for loc in locations:
    for filename in ['daily_o2_chart.html', 'index.html']:
        with open(os.path.join(loc, filename), 'w', encoding='utf-8') as f:
            f.write(html_v5_code)

print("V5 Dashboard with Separated Hospital & Cancer Center Cylinder Inventories generated successfully!")
