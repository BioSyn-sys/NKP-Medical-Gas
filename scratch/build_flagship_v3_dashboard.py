...
html_v3_code = f"""<!DOCTYPE html>
<html lang="th" data-theme="dark">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>NKP Medical Oxygen Analytics Dashboard</title>
...
<body>
    ...
    <aside class="sidebar">
        ...
        <!-- Vertical Sidebar Menu Bar -->
        <nav class="sidebar-menu">
            <button class="menu-item active" id="menu-daily" onclick="switchTab('daily')">
                <i class="fa-solid fa-chart-line"></i> 1. วิเคราะห์รายวัน (91 วัน)
            </button>
            <button class="menu-item" id="menu-monthly" onclick="switchTab('monthly')">
                <i class="fa-solid fa-calendar-days"></i> 2. สถิติประวัติรายเดือน
            </button>
            <button class="menu-item" id="menu-cost" onclick="switchTab('cost')">
                <i class="fa-solid fa-calculator"></i> 3. เปรียบเทียบต้นทุน (LOX/6Q)
            </button>
            <button class="menu-item" id="menu-emergency" onclick="switchTab('emergency')">
                <i class="fa-solid fa-shield-cat"></i> 4. แผนก๊าซสำรองฉุกเฉิน
            </button>
            <button class="menu-item" id="menu-import" onclick="switchTab('import')">
...
for loc in locations:
    for filename in ['daily_o2_chart.html', 'index.html']:
        with open(os.path.join(loc, filename), 'w', encoding='utf-8') as f:
            f.write(html_v3_code)

print("V3 Sidebar Dashboard with Live Clock & Light/Dark Theme Switcher generated successfully!")
